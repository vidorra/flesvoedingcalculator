      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-7">
          <div className="space-y-6">
            ...
            <div className="text-sm text-gray-600 mb-2">Financiële Aspecten • Kosten</div>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 font-semibold text-primary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-gray-600 font-semibold text-primary mb-6">Flesvoeding poeder: Prijsoverzicht per merk</h2>
            ...
            <section className="mb-8">
              <h2 className="text-gray-600 font-semibold text-primary mb-6">Flessen en spenen: Wat heb je nodig?</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="font-medium text-primary mb-4">Minimum benodigdheden</h3>
                ...
                <div>
                  <h3 className="font-medium text-primary mb-4">Aanbevolen hoeveelheden per leeftijd</h3>
                  <ul className="space-y-2">
                    <li className="flex items-center space-x-2">
                      <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0"></div>
            ...
            <section className="mb-8">
              <h2 className="text-gray-600 font-semibold text-primary mb-6">25 Bespaartips zonder kwaliteitsverlies</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="font-medium text-primary mb-4">Inkooptips (besparing: €150-200/jaar)</h3>
                  <ul className="space-y-2">
                ...
                <div>
                  <h3 className="font-medium text-primary mb-4">Slim gebruik (besparing: €50-100/jaar)</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0 mt-2"></div>
                ...
                <div>
                  <h3 className="font-medium text-primary mb-4">Equipment besparing (besparing: €100-150 eenmalig)</h3>
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <div className="w-2 h-2 bg-primary rounded-full flex-shrink-0 mt-2"></div>
            ...
            <section className="mb-8">
              <h2 className="text-gray-600 font-semibold text-primary mb-6">🛒 Waar het goedkoopst winkelen?</h2>
            ...
            <section className="mb-8">
              <h2 className="text-gray-600 font-semibold text-primary mb-6">Conclusie: Slim budgetteren voor flesvoeding</h2>

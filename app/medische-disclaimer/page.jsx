      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {warnings.map((warning, index) => (
            <div key={index} className={`bg-${warning.color}-50 rounded-2xl shadow-sm border border-${warning.color}-200 p-6`}>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h3 className={`font-semibold text-${warning.color}-800 mb-2`}>{warning.title}</h3>
        ...
        <div className="bg-white/80 backdrop-blur rounded-2xl shadow-sm border border-gray-200 p-6">
          <h2 className="font-semibold text-gray-800 mb-4">Beperkingen van de Calculator</h2>
        ...
        <div className="bg-green-50 rounded-2xl shadow-sm border border-green-200 p-6">
          <h2 className="font-semibold text-green-800 mb-4">Betrouwbaarheid van Informatie</h2>
        ...
        <div className="bg-gray-50 rounded-2xl shadow-sm border border-gray-200 p-6">
          <h2 className="font-semibold text-gray-800 mb-4">Aansprakelijkheid</h2>
        ...
        <div className="bg-primary rounded-2xl shadow-lg p-6 text-white">
          <h2 className="font-semibold mb-2">Vragen over deze disclaimer?</h2>

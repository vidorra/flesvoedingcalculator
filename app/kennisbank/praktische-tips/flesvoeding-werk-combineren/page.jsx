        ...
        <div className="col-span-12 lg:col-span-7">
          <div className="space-y-6">
              ...
              <div className="space-y-4">
                {dutchScenarios.map((scenario, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg p-4">
                    <h3 className="font-semibold text-gray-800 mb-2">{scenario.type}</h3>
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <h4 className="font-medium text-gray-600 text-sm mb-1">Timeline</h4>
                        <p className="text-sm text-gray-700">{scenario.timeline}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-600 text-sm mb-1">Voorbereiding</h4>
                        <p className="text-sm text-gray-700">{scenario.prep}</p>
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-600 text-sm mb-1">Voordeel</h4>
                        <p className="text-sm text-gray-700">{scenario.advantage}</p>
                      </div>
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white/80 backdrop-blur rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="mb-6">
                <h3 className="font-medium text-gray-700 mb-3">📋 Essential Information Checklist</h3>
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-gray-50 rounded-lg p-3">
                    <h4 className="font-medium text-gray-700 mb-2">Voeding Details</h4>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    <h4 className="font-medium text-gray-700 mb-2">Praktische Info</h4>
                    <div className="text-sm text-gray-600 space-y-1">
            ...
            <div className="bg-white/80 backdrop-blur rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-6">
                {scheduleExamples.map((schedule, index) => (
                  <div key={index} className="border border-gray-200 rounded-lg p-4">
                    <h3 className="font-semibold text-gray-800 mb-4">{schedule.type}</h3>
              ...
              <div className="space-y-4">
                {stressManagement.map((item, index) => (
                  <div key={index} className="border-l-4 border-primary pl-4 py-2">
                    <h3 className="font-medium text-gray-800 mb-1">"{item.concern}"</h3>

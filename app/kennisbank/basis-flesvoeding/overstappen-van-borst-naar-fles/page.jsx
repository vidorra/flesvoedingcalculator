                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <ul className="space-y-1">
                        ...
                        <li className="text-gray-600 text-sm">• 8-12 voedingen per dag</li>
                        <li className="text-gray-600 text-sm">• Totaal: 480-720ml per dag</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        ...
                        <li className="text-gray-600 text-sm">• 6-8 voedingen per dag</li>
                        <li className="text-gray-600 text-sm">• Totaal: 720-960ml per dag</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="space-y-1">
                        ...
                        <li className="text-gray-600 text-sm">• 4-6 voedingen per dag</li>
                        <li className="text-gray-600 text-sm">• Totaal: 480-720ml per dag (door bijvoeding)</li>
                      </ul>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <ul className="text-gray-600 text-sm space-y-1">
                          <li>• 1 flesvoeding per dag succesvol</li>
                          <li>• Mogelijk enige weerstand baby</li>
                          <li>• Lichte ongemak borsten</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <ul className="text-gray-600 text-sm space-y-1">
                          <li>• 2-3 flesvoedingen per dag</li>
                          <li>• Baby went aan nieuwe routine</li>
                          <li>• Melkproductie begint af te nemen</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <ul className="text-gray-600 text-sm space-y-1">
                          <li>• Meerderheid voedingen via fles</li>
                          <li>• Nog 1-2 borstvoedingen per dag</li>
                          <li>• Borsten minder vol</li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <ul className="text-gray-600 text-sm space-y-1">
                          <li>• Volledige overstap mogelijk</li>
                          <li>• Of bewust behoud 1 borstvoeding</li>
                          <li>• Nieuwe routine ingesteld</li>
                        </ul>
                      </div>
                    </div>
                  </div>

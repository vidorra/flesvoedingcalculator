...
export async function getKennisbankProductLinks(productNames) {
  ...
  const mockProducts = [
    {
      ...
      imageUrl: 'https://media.s-bol.com/imgshop/s/q/400x400/9200000128074141.jpg',
      rating: 4.5,
      affiliateLink: bolAPI.generateAffiliateLink('9200000128074141', 'Philips Avent Elektrische Stoomsterilisator'),
      originalUrl: 'https://www.bol.com/nl/nl/p/9200000128074141/'
    },
    {
      id: '9200000093845588',
      ...
      imageUrl: 'https://media.s-bol.com/imgshop/s/q/400x400/9200000093845588.jpg',
      rating: 4.3,
      affiliateLink: bolAPI.generateAffiliateLink('9200000093845588', 'MAM Easy Start Anti-Colic Babyfles'),
      originalUrl: 'https://www.bol.com/nl/nl/p/9200000093845588/'
    },
    {
      id: '9200000125068495',
      ...
      imageUrl: 'https://media.s-bol.com/imgshop/s/q/400x400/9200000125068495.jpg',
      rating: 4.2,
      affiliateLink: bolAPI.generateAffiliateLink('9200000125068495', 'Chicco Sterilisator Digitaal 2-in-1'),
      originalUrl: 'https://www.bol.com/nl/nl/p/9200000125068495/'
    },
    {
      id: '9200000089123456',
      title: 'Magnetron Sterilisatorzakjes - 5 stuks',
      summary: 'Herbruikbare sterilisatorzakjes voor magnetron. Tot 20x te gebruiken.',
      price: 899, // €8.99 in cents
      imageUrl: 'https://media.s-bol.com/imgshop/s/q/400x400/sterilizer-bags.jpg',
      rating: 4.1,
      affiliateLink: bolAPI.generateAffiliateLink('9200000089123456', 'Magnetron Sterilisatorzakjes'),
      originalUrl: 'https://www.bol.com/nl/nl/p/9200000089123456/'
    },
    {
      id: '9200000076543210',
      ...
      imageUrl: 'https://media.s-bol.com/imgshop/s/q/400x400/bottle-tongs.jpg',
      rating: 4.0,
    ...
    {
      id: '9200000098765432',
      title: 'Sterilisatie Tabletten - Milton - 28 stuks',
      summary: 'Koude sterilisatie tabletten. Ideaal voor onderweg.',
      price: 1149, // €11.49 in cents
      imageUrl: 'https://media.s-bol.com/imgshop/s/q/400x400/milton-tablets.jpg',
      rating: 3.9,
  ...
  console.log('Using fallback affiliate products due to network connectivity issue')

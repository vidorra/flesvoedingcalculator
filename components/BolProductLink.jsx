    ...
    return (
      ...
      >
        ...
        <div className="flex items-center space-x-1 text-xs">
          <span className="bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full">bol.com</span>
      ...
      >
        <div className="flex items-center space-x-3 p-3 bg-white rounded-lg border border-gray-200 hover:border-orange-300 hover:bg-orange-50 transition-colors">
          ...
          <div className="flex-1 min-w-0">
            <h4 className="font-medium text-gray-900 group-hover:text-orange-700 transition-colors line-clamp-2">
              {product.title}
            </h4>
